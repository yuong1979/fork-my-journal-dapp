...
pub mod tester {
    ...
    pub fn initialize_expense(
        ...
        expense_account.owner = *ctx.accounts.authority.key; // needs to be dereferenced because &mut ctx.accounts.expense_account is referenced
...
// https://youtu.be/je6mhk7neS4?t=639 - add move to your charts to track treasury volatility.
