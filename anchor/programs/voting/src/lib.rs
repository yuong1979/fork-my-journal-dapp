...
declare_id!("D6Kkwotrbt6CDaRvYAnW1bSTiH3u3bGTxd6N78WUVV6X");
...
#[derive(Accounts)]
// #[instruction(vote_type: VoteType)] # this line is optional and can be added it makes it clear that vote_type is an input parameter for the instruction
